sudo pacman -S lxappearance picom nitrogen rofi chromium polybar neovim zsh lightdm lightdm-slick-greeter nodejs npm ntfs-3g docker docker-compose nautilus alsa-utils alsa-plugins alsa-lib alsa-firmware unzip ripgrep gvfs-mtp
